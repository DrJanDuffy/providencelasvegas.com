...
export const metadata: Metadata = {
  ...
  description:
    "Find Inspirada homes with Berkshire Hathaway HomeServices Nevada Properties. Dr. Jan Duffy specializes in Henderson's resort-style community. Median price $525K. Call (702) 919-7702.",
  keywords: [
...
export default function InspiradaPage() {
  const inspiradaFAQs = getFAQsForPage("inspirada");

  return (
    <>
      <FAQSchema faqs={inspiradaFAQs} />
      <Navbar />
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <FAQSection
            faqs={inspiradaFAQs}
            title="Frequently Asked Questions About Inspirada"
            subtitle="Common questions about Henderson's resort-style community"
          />
