...
export const metadata: Metadata = {
  ...
  description:
    "Find Inspirada homes with Berkshire Hathaway HomeServices Nevada Properties. Dr. Jan Duffy specializes in Henderson's resort-style community. Median price $525K. Call (702) 744-2993.",
  keywords: [
