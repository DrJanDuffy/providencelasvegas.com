...
export const metadata: Metadata = {
  ...
  description:
    "Find Henderson homes with Berkshire Hathaway HomeServices Nevada Properties. Dr. Jan Duffy specializes in Henderson's family-friendly communities. Median price $485K. Call (702) 744-2993.",
  keywords: [
...
export default function HendersonPage() {
  const hendersonFAQs = getFAQsForPage("henderson");
    ...
    <>
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <FAQSection
            faqs={hendersonFAQs}
            title="Frequently Asked Questions About Henderson Real Estate"
            subtitle="Common questions about buying, selling, and living in Henderson"
          />
