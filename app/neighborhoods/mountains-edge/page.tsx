...
export const metadata: Metadata = {
  ...
  description:
    "Find Mountains Edge homes with Berkshire Hathaway HomeServices Nevada Properties. Dr. Jan Duffy specializes in this southwest Las Vegas community. Median price $475K. Call (702) 919-7702.",
  keywords: [
