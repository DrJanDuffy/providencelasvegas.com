...
export const metadata: Metadata = {
  ...
  description:
    "Find luxury homes in The Ridges with Berkshire Hathaway HomeServices Nevada Properties. Dr. Jan Duffy specializes in Summerlin's most exclusive guard-gated community. Median price $2.5M. Call (702) 919-7702.",
  keywords: [
...
export default function TheRidgesPage() {
  const theRidgesFAQs = getFAQsForPage("the-ridges");

  return (
    <>
      <FAQSchema faqs={theRidgesFAQs} />
      <Navbar />
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <FAQSection
            faqs={theRidgesFAQs}
            title="Frequently Asked Questions About The Ridges"
            subtitle="Common questions about luxury living in Summerlin's most exclusive community"
          />
