...
export const metadata: Metadata = {
  ...
  description:
    "Henderson's premier 55+ community. Sun City Anthem homes from $350K-$1.2M. 2 championship golf courses, stunning mountain views. Dr. Jan Duffy. Call (702) 744-2993.",
  keywords: [
