...
export const metadata: Metadata = {
  ...
  description:
    "Free buyer representation on new construction homes in Las Vegas. Dr. Jan Duffy helps you navigate builder contracts, negotiate upgrades, and secure incentives. Call (702) 919-7702.",
  keywords: [
        ...
        <div className="container mx-auto px-4">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-amber-800 text-sm">
                    ...
                    Call <a href="tel:+17029197702" className="font-bold underline">(702) 919-7702</a> to 
              ...
              <div className="flex items-start">
                ...
                <div className="bg-white border border-slate-200 rounded-xl p-6 flex-grow">
                  ...
                  <p className="text-slate-600">
                    Call{" "}
                    <a href="tel:+17029197702" className="text-blue-600 font-semibold hover:underline">
                      (702) 919-7702
                    </a>{" "}
          ...
          <section className="text-center bg-blue-600 text-white rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Call <strong>(702) 919-7702</strong> to register Dr. Jan Duffy as your buyer's agent 
