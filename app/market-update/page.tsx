...
export const metadata: Metadata = {
  ...
  description:
    "Weekly Las Vegas real estate market update from Berkshire Hathaway HomeServices Nevada Properties. Get the latest stats, notable sales, and expert analysis from Dr. Jan Duffy. Call (702) 919-7702.",
  keywords: [
