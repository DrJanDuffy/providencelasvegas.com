...
export const metadata: Metadata = {
  ...
  description:
    "Moving to Las Vegas? Dr. Jan Duffy at Berkshire Hathaway HomeServices Nevada Properties provides comprehensive relocation services. Schools, neighborhoods, cost of living. Call (702) 919-7702.",
  keywords: [
...
export default function RelocationPage() {
  const relocationFAQs = getFAQsForPage("relocation");
    ...
    <>
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <FAQSection
            faqs={relocationFAQs}
            title="Relocation Frequently Asked Questions"
            subtitle="Moving to a new city raises many questions. Here are answers to the most common concerns from people relocating to Las Vegas."
          />
