...
export const metadata: Metadata = {
  ...
  description:
    "Discover why Berkshire Hathaway HomeServices is the most trusted name for Providence Las Vegas real estate. Backed by Warren Buffett. BHHS Nevada Properties. Call (702) 919-7702.",
  keywords: [
...
const organizationSchema = {
  ...
  logo: "https://www.providencelasvegas.com/favicon-32x32.png",
  description:
