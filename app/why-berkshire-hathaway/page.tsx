...
export const metadata: Metadata = {
  ...
  description:
    "Discover why Berkshire Hathaway HomeServices is the most trusted name for Providence Las Vegas real estate. Backed by Warren Buffett. BHHS Nevada Properties. Call (702) 744-2993.",
  keywords: [
