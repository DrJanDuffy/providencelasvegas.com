...
export const metadata: Metadata = {
  ...
  description:
    "Ready for your next chapter? Dr. Jan Duffy helps Providence Las Vegas homeowners leverage equity into their dream home. Sell and buy seamlessly. Call (702) 744-2993.",
  keywords: [
