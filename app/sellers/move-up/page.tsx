...
export const metadata: Metadata = {
  ...
  description:
    "Ready for your next chapter? Dr. Jan Duffy helps Providence Las Vegas homeowners leverage equity into their dream home. Sell and buy seamlessly. Call (702) 919-7702.",
  keywords: [
...
export default function MoveUpSellerPage() {
  const moveUpFAQs = getFAQsForPage("sellers/move-up");
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            >
              ...
              Start Your Upgrade → (702) 919-7702
            </a>
          </div>
          ...
          <FAQSection
            ...
            subtitle="Common questions about selling and buying your next home"
          />
