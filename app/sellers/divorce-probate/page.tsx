...
export const metadata: Metadata = {
  ...
  description:
    "Sensitive real estate situations handled with discretion. Dr. Jan Duffy helps with divorce sales, probate, estate liquidation, and court-ordered sales. Call (702) 744-2993.",
  keywords: [
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            >
              ...
              Confidential Consultation → (702) 744-2993
            </a>
          </div>
